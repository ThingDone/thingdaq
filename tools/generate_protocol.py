...
def validate_v2_contract(
    ...
    if contract.get("status") != "experimental" or contract.get("extension") != (
        ...
        raise ContractError("protocol v2 must identify the experimental aux-input bank")
    ...
    if len(rate_profiles) != 4 or rate_enum != {
    ...
    for profile in rate_profiles:
        ...
        if (
            ...
            or int(profile["adc_pair_pit_divider"]) != 4
            or int(profile["adc_pair_pit_load"]) != 3

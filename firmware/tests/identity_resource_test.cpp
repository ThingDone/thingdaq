...
static_assert(teensy_daq::board::kPacketBufferCount == 32U);
static_assert(teensy_daq::board::kPacketBufferStorageBytes == 131072U);
...
static_assert(teensy_daq::board::kReservedRam1Bytes == 137632U);

...
static_assert(teensy_daq::board::kPacketBufferCount == 64U);
static_assert(teensy_daq::board::kPacketBufferStorageBytes == 262144U);
...
static_assert(teensy_daq::board::kReservedRam1Bytes == 269728U);

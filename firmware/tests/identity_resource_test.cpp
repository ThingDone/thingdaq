...
static_assert(teensy_daq::board::kAdcDmaRingBytes == 16256U);
...
static_assert(teensy_daq::board::kAdcEdmaPriorities[0] == 1U);
static_assert(teensy_daq::board::kAdcEdmaPriorities[1] == 0U);

...
PORTABLE_SOURCES = (
    ...
    FIRMWARE_SOURCE / "adc_trigger.cpp",
    FIRMWARE_SOURCE / "adc_frame_packer.h",
    FIRMWARE_SOURCE / "adc_frame_packer.cpp",

...
MODES = {
    "baseline": "",
    "unrolled": "THINGDAQ_EXPERIMENT_ADLER_UNROLL",
...
def main() -> int:
    ...
    mode = args.mode
    if mode == "unrolled":
        # Pinned Arm GCC 15.2.1 symbol size for the four-byte weighted loop.
        # Retain the exact-size gate, with the experimental implementation's size.
        base.CHECKSUM_CODE_BYTES = {**base.CHECKSUM_CODE_BYTES, "ADLER32": 236}

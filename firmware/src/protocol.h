...
struct Configuration {
  ...
  protocol_v2::RateProfile rate_profile =
      input_experiment::kReleaseFixed1MHz
          ? protocol_v2::RateProfile::kAdc1mhzGpio1mhz
          : protocol_v2::kDefaultRateProfile;
  std::uint8_t protocol_version = input_experiment::kReleaseFixed1MHz
      ? protocol_v2::kProtocolVersion : protocol_v1::kProtocolVersion;
};
...
struct GpioClockDiagnosticRequest {
  std::uint32_t rate_hz = input_experiment::kReleaseFixed1MHz
      ? 1000000U : protocol_v1::kGpioClockProductionRateHz;

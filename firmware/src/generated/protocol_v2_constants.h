...
inline constexpr char kSourceSha256[] = "bd130fa45143266cd231c99935e3d52f33b452f9fea96f75c1cbbb415f67cb00";
...
inline constexpr std::size_t kMaxControlFrameBytes = 1536U;
...
inline constexpr std::size_t kTemperatureResponseErrorCodeOffset = 2U;
inline constexpr std::size_t kTemperatureResponseTemperatureStatusOffset = 4U;
inline constexpr std::size_t kTemperatureResponseReserved1Offset = 5U;
inline constexpr std::size_t kTemperatureResponseReserved2Offset = 6U;
inline constexpr std::size_t kTemperatureResponseMillidegreesCBitsOffset = 8U;
...
inline constexpr std::size_t kInfoResponsePayloadSize = 680U;
...
inline constexpr std::size_t kInfoResponseRateProfilesCount = 5U;
...
inline constexpr std::size_t kStatusResponsePayloadSize = 1476U;
...
inline constexpr std::size_t kStatusResponseProtocolVersionOffset = 1228U;
inline constexpr std::size_t kStatusResponseAuxBankModeOffset = 1229U;
inline constexpr std::size_t kStatusResponseRateProfileOffset = 1230U;
inline constexpr std::size_t kStatusResponseGpioItemBytesOffset = 1231U;
inline constexpr std::size_t kStatusResponseAdcPairRateHzOffset = 1232U;
inline constexpr std::size_t kStatusResponseGpioSampleRateHzOffset = 1236U;
inline constexpr std::size_t kStatusResponseFrameCoverageTicksOffset = 1240U;
inline constexpr std::size_t kStatusResponsePacketRetentionUsCombinedOffset = 1244U;
inline constexpr std::size_t kStatusResponsePacketRetentionUsSingleStreamOffset = 1248U;
inline constexpr std::size_t kStatusResponsePrimaryGpioRawReadyDepthOffset = 1252U;
inline constexpr std::size_t kStatusResponseAuxGpioRawReadyDepthOffset = 1254U;
inline constexpr std::size_t kStatusResponsePrimaryGpioRawReadyHighWaterOffset = 1256U;
inline constexpr std::size_t kStatusResponseAuxGpioRawReadyHighWaterOffset = 1258U;
inline constexpr std::size_t kStatusResponseReserved4Offset = 1260U;
inline constexpr std::size_t kStatusResponsePrimaryGpioDmaMajorLoopsOffset = 1264U;
inline constexpr std::size_t kStatusResponseAuxGpioDmaMajorLoopsOffset = 1272U;
inline constexpr std::size_t kStatusResponsePrimaryGpioSamplesCapturedOffset = 1280U;
inline constexpr std::size_t kStatusResponseAuxGpioSamplesCapturedOffset = 1288U;
inline constexpr std::size_t kStatusResponsePairedGpioDmaMajorLoopsOffset = 1296U;
inline constexpr std::size_t kStatusResponsePairedGpioBuffersCompletedOffset = 1304U;
inline constexpr std::size_t kStatusResponsePairedGpioBuffersAcquiredOffset = 1312U;
inline constexpr std::size_t kStatusResponsePairedGpioBuffersReleasedOffset = 1320U;
inline constexpr std::size_t kStatusResponsePairedGpioSamplesCapturedOffset = 1328U;
inline constexpr std::size_t kStatusResponsePairedGpioSamplesJoinedOffset = 1336U;
inline constexpr std::size_t kStatusResponsePairedGpioSamplesDeliveredOffset = 1344U;
inline constexpr std::size_t kStatusResponsePairedGpioSamplesLostOffset = 1352U;
inline constexpr std::size_t kStatusResponsePairedGpioRawRingOverrunsOffset = 1360U;
inline constexpr std::size_t kStatusResponsePairedGpioGenerationSkewEventsOffset = 1368U;
inline constexpr std::size_t kStatusResponsePairedGpioGenerationSkewSamplesOffset = 1376U;
inline constexpr std::size_t kStatusResponsePairedGpioCanceledGenerationsOffset = 1384U;
inline constexpr std::size_t kStatusResponsePairedGpioCancellationSamplesOffset = 1392U;
inline constexpr std::size_t kStatusResponsePairedGpioStopTailSamplesOffset = 1400U;
inline constexpr std::size_t kStatusResponsePairedGpioTimestampMismatchesOffset = 1408U;
inline constexpr std::size_t kStatusResponsePairedGpioCountMismatchesOffset = 1412U;
inline constexpr std::size_t kStatusResponsePairedGpioDestinationMismatchesOffset = 1416U;
inline constexpr std::size_t kStatusResponsePairedGpioScheduleExhaustionsOffset = 1420U;
inline constexpr std::size_t kStatusResponsePairedGpioStaleCompletionsOffset = 1424U;
inline constexpr std::size_t kStatusResponsePairedGpioCacheDmaDiscardsOffset = 1428U;
inline constexpr std::size_t kStatusResponsePairedGpioCacheCpuInvalidationsOffset = 1432U;
inline constexpr std::size_t kStatusResponsePairedGpioHardwareErrorsOffset = 1436U;
inline constexpr std::size_t kStatusResponsePairedGpioInvariantErrorsOffset = 1440U;
inline constexpr std::size_t kStatusResponsePairedGpioResourceConflictsOffset = 1444U;
inline constexpr std::size_t kStatusResponsePairedGpioStartErrorsOffset = 1448U;
inline constexpr std::size_t kStatusResponsePairedGpioStopErrorsOffset = 1452U;
inline constexpr std::size_t kStatusResponsePairedGpioStaleDmaCompletionsOffset = 1456U;
inline constexpr std::size_t kStatusResponsePrimaryGpioRawRingOverrunsOffset = 1460U;
inline constexpr std::size_t kStatusResponseAuxGpioRawRingOverrunsOffset = 1464U;
inline constexpr std::size_t kStatusResponsePrimaryGpioStaleCompletionsOffset = 1468U;
inline constexpr std::size_t kStatusResponseAuxGpioStaleCompletionsOffset = 1472U;
...
inline constexpr std::size_t kGpioCaptureDiagnosticResponsePayloadSize = 272U;
...
inline constexpr std::size_t kGpioCaptureDiagnosticResponseBankCountOffset = 144U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxBankModeOffset = 145U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseSelectedRateProfileOffset = 146U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxElectricallyUnstimulatedOffset = 147U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxExternalTransitionChecksRunOffset = 148U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseReserved3Offset = 149U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseReserved4Offset = 150U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseConfiguredRateHzOffset = 152U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxHardwareErrorFlagsOffset = 156U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxDiagnosticFlagsOffset = 160U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxDmaSamplesCapturedOffset = 164U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxCompleteSamplesRetainedOffset = 172U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxSamplesAnalyzedOffset = 176U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxStoppedPartialSamplesOffset = 180U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxRawWordAndOffset = 184U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxRawWordOrOffset = 188U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxObservedTransitionsOffset = 192U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxPackedValueAndOffset = 196U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxPackedValueOrOffset = 197U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxFirstPackedValueOffset = 198U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxLastPackedValueOffset = 199U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpr26BeforeOffset = 200U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpr26ConfiguredOffset = 204U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpr26AfterOffset = 208U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpio1GdirBeforeOffset = 212U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpio1GdirConfiguredOffset = 216U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpio1GdirAfterOffset = 220U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpio1PsrBeforeOffset = 224U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpio1PsrConfiguredOffset = 228U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseGpio1PsrAfterOffset = 232U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxDmamuxChcfgConfiguredOffset = 236U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxDmaErqConfiguredOffset = 240U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxDmaErrFinalOffset = 244U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxTcdCiterConfiguredOffset = 248U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxTcdBiterConfiguredOffset = 250U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxTcdCsrConfiguredOffset = 252U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxEdmaPriorityConfiguredOffset = 254U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseReserved5Offset = 255U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponsePrimaryCacheDmaDiscardsOffset = 256U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxCacheDmaDiscardsOffset = 260U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponsePrimaryCacheCpuInvalidationsOffset = 264U;
inline constexpr std::size_t kGpioCaptureDiagnosticResponseAuxCacheCpuInvalidationsOffset = 268U;
...
constexpr std::uint16_t allowedFlags(FrameKind kind) {
  switch (kind) {
    ...
    case FrameKind::kErrorResponse:
      return static_cast<std::uint16_t>(FrameFlag::kResponseError);
    case FrameKind::kGetTemperatureRequest:
      return 0U;
...
inline constexpr std::uint8_t kSupportedRateProfileMask = 31U;
...
inline constexpr RateProfileTiming kRateProfiles[] = {
    ...
    {RateProfile::kAdc1mhzGpio1mhz, 1000000U, 1000000U, 8U, 4U, 8U, 24U, 23U, 1U, 0U, 75U, 300U, 8096U, 4048U},
};
static_assert(sizeof(kRateProfiles) / sizeof(kRateProfiles[0]) == 5U);

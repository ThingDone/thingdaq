...
inline constexpr std::uint32_t kOutputRateHz = 1000000U;
inline constexpr std::uint8_t kOutputDurationQuantumUs = 1U;
inline constexpr std::uint32_t kOutputPeriodTicks = 8U;
inline constexpr std::uint32_t kOutputFirstEventTick = 0U;
inline constexpr std::uint8_t kOutputStateWidthBits = 8U;
inline constexpr std::uint32_t kOutputLegalStateMask = 255U;
inline constexpr std::size_t kOutputSegmentBytes = 8U;
inline constexpr std::size_t kOutputSegmentCapacity = 1024U;
inline constexpr std::size_t kOutputMinimumCommittedSegments = 1U;
inline constexpr std::uint32_t kOutputRepeatForever = 0U;
inline constexpr std::uint8_t kOutputPinsByLogicalBit[] = {16U, 17U, 18U, 19U, 20U, 21U, 22U, 23U};
inline constexpr std::uint8_t kOutputGpioBitsByLogicalBit[] = {23U, 22U, 17U, 16U, 26U, 27U, 24U, 25U};
inline constexpr std::uint32_t kOutputGpioAggregateMask = 264437760U;
inline constexpr std::uint8_t kOutputStandardGpio = 1U;
inline constexpr std::uint8_t kOutputFastGpio = 6U;
inline constexpr std::uint8_t kOutputFastSelectGpr = 26U;
inline constexpr std::uint16_t kOutputLogicVoltageMaxMv = 3300U;
inline constexpr std::uint8_t kOutputPitChannel = 1U;
inline constexpr std::uint8_t kOutputXbarInput = 57U;
...
enum class FrameKind : std::uint8_t {
  ...
  kOutputBeginRequest = 32U,
  kOutputBeginResponse = 160U,
  kOutputAppendRequest = 33U,
  kOutputAppendResponse = 161U,
  kOutputCommitRequest = 34U,
  kOutputCommitResponse = 162U,
  kOutputArmRequest = 35U,
  kOutputArmResponse = 163U,
  kOutputStatusRequest = 36U,
  kOutputStatusResponse = 164U,
  kOutputClearRequest = 37U,
  kOutputClearResponse = 165U,
  kErrorResponse = 159U,
};
...
enum class Capability : std::uint32_t {
  ...
  kPreloadedAuxiliaryOutput = 512U,
  kCommonEpochOutput = 1024U,
};
...
enum class OutputBankMode : std::uint8_t {
  kDisabled = 0U,
  kOutput = 1U,
};
...
enum class OutputError : std::uint8_t {
  kNone = 0U,
  kInvalidSegment = 1U,
  kCapacityExceeded = 2U,
  kChecksumMismatch = 3U,
  kGenerationMismatch = 4U,
  kInvalidLifecycle = 5U,
  kTruncatedUpload = 6U,
  kUnderrun = 7U,
  kDmaFault = 8U,
  kReleaseFailed = 9U,
...
inline constexpr std::size_t kInfoResponsePayloadSize = 412U;
...
inline constexpr std::size_t kInfoResponseOutputBankModeOffset = 376U;
inline constexpr std::size_t kInfoResponseOutputPinCountOffset = 377U;
inline constexpr std::size_t kInfoResponseOutputStateWidthBitsOffset = 378U;
inline constexpr std::size_t kInfoResponseOutputDurationQuantumUsOffset = 379U;
inline constexpr std::size_t kInfoResponseOutputPinMapOffset = 380U;
inline constexpr std::size_t kInfoResponseOutputPinMapCount = 8U;
inline constexpr std::size_t kInfoResponseOutputGpioBitsByLogicalBitOffset = 388U;
inline constexpr std::size_t kInfoResponseOutputGpioBitsByLogicalBitCount = 8U;
inline constexpr std::size_t kInfoResponseOutputRateHzOffset = 396U;
inline constexpr std::size_t kInfoResponseOutputPeriodTicksOffset = 400U;
inline constexpr std::size_t kInfoResponseOutputCapacitySegmentsOffset = 404U;
inline constexpr std::size_t kInfoResponseOutputLegalStateMaskOffset = 408U;
...
inline constexpr std::size_t kOutputBeginRequestPayloadSize = 8U;
inline constexpr std::size_t kOutputBeginRequestRepeatCountOffset = 0U;
inline constexpr std::size_t kOutputBeginRequestIdleStateMaskOffset = 4U;
inline constexpr std::size_t kOutputAppendRequestPayloadSize = 8U;
inline constexpr std::size_t kOutputAppendRequestDurationSamplesOffset = 0U;
inline constexpr std::size_t kOutputAppendRequestLogicalStateMaskOffset = 4U;
inline constexpr std::size_t kOutputCommitRequestPayloadSize = 8U;
inline constexpr std::size_t kOutputCommitRequestSegmentCountOffset = 0U;
inline constexpr std::size_t kOutputCommitRequestProgramChecksumOffset = 4U;
inline constexpr std::size_t kOutputAppendResponsePayloadSize = 16U;
inline constexpr std::size_t kOutputAppendResponseResponseStatusOffset = 0U;
inline constexpr std::size_t kOutputAppendResponseReservedOffset = 1U;
inline constexpr std::size_t kOutputAppendResponseErrorCodeOffset = 2U;
...
inline constexpr std::size_t kOutputStatusResponseOutputStateOffset = 4U;
inline constexpr std::size_t kOutputStatusResponseOutputBankModeOffset = 5U;
inline constexpr std::size_t kOutputStatusResponseFaultLatchedOffset = 6U;
inline constexpr std::size_t kOutputStatusResponseReserved1Offset = 7U;
inline constexpr std::size_t kOutputStatusResponseGenerationOffset = 8U;
inline constexpr std::size_t kOutputStatusResponseIdleStateMaskOffset = 12U;
inline constexpr std::size_t kOutputStatusResponseCurrentStateMaskOffset = 16U;
inline constexpr std::size_t kOutputStatusResponseLastEmittedStateMaskOffset = 20U;
inline constexpr std::size_t kOutputStatusResponseRepeatCountOffset = 24U;
inline constexpr std::size_t kOutputStatusResponseCompletedRepeatsOffset = 28U;
inline constexpr std::size_t kOutputStatusResponseSegmentCountOffset = 32U;
inline constexpr std::size_t kOutputStatusResponseAcceptedSegmentCountOffset = 36U;
inline constexpr std::size_t kOutputStatusResponseProgramChecksumOffset = 40U;
inline constexpr std::size_t kOutputStatusResponseCurrentSegmentIndexOffset = 44U;
inline constexpr std::size_t kOutputStatusResponseTicksElapsedOffset = 48U;
inline constexpr std::size_t kOutputStatusResponseTransitionsEmittedOffset = 56U;
...
constexpr std::uint16_t allowedFlags(FrameKind kind) {
  switch (kind) {
    ...
    case FrameKind::kGpioCaptureDiagnosticResponse:
      return static_cast<std::uint16_t>(FrameFlag::kResponseError);
    case FrameKind::kOutputBeginRequest:
      return 0U;
    case FrameKind::kOutputBeginResponse:
      return static_cast<std::uint16_t>(FrameFlag::kResponseError);
    case FrameKind::kOutputAppendRequest:
      return 0U;
    case FrameKind::kOutputAppendResponse:
      return static_cast<std::uint16_t>(FrameFlag::kResponseError);
    case FrameKind::kOutputCommitRequest:
      return 0U;
    case FrameKind::kOutputCommitResponse:
      return static_cast<std::uint16_t>(FrameFlag::kResponseError);
    case FrameKind::kOutputArmRequest:
      return 0U;
    case FrameKind::kOutputArmResponse:
      return static_cast<std::uint16_t>(FrameFlag::kResponseError);
    case FrameKind::kOutputStatusRequest:
      return 0U;
    case FrameKind::kOutputStatusResponse:
      return static_cast<std::uint16_t>(FrameFlag::kResponseError);
    case FrameKind::kOutputClearRequest:
      return 0U;
    case FrameKind::kOutputClearResponse:
      return static_cast<std::uint16_t>(FrameFlag::kResponseError);
...
constexpr FrameKind requestFrameKind(CommandKind command) {
  switch (command) {
    ...
    case CommandKind::kOutputBegin:
      return FrameKind::kOutputBeginRequest;
    case CommandKind::kOutputAppend:
      return FrameKind::kOutputAppendRequest;
    case CommandKind::kOutputCommit:
      return FrameKind::kOutputCommitRequest;
    case CommandKind::kOutputArm:
      return FrameKind::kOutputArmRequest;
    case CommandKind::kOutputStatus:
      return FrameKind::kOutputStatusRequest;
    case CommandKind::kOutputClear:
      return FrameKind::kOutputClearRequest;
  }
  return FrameKind::kInfoRequest;
}
...
constexpr FrameKind responseFrameKind(CommandKind command) {
  switch (command) {
    ...
    case CommandKind::kOutputBegin:
      return FrameKind::kOutputBeginResponse;
    case CommandKind::kOutputAppend:
      return FrameKind::kOutputAppendResponse;
    case CommandKind::kOutputCommit:
      return FrameKind::kOutputCommitResponse;
    case CommandKind::kOutputArm:
      return FrameKind::kOutputArmResponse;
    case CommandKind::kOutputStatus:
      return FrameKind::kOutputStatusResponse;
    case CommandKind::kOutputClear:
      return FrameKind::kOutputClearResponse;
  }
  return FrameKind::kInfoResponse;
}

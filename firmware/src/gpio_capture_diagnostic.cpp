...
#define THINGDAQ_GPIO_DIAGNOSTIC_COLD_CODE(section_name) \
...
THINGDAQ_GPIO_DIAGNOSTIC_COLD_CODE(".flashmem.gpio_diagnostic.policy")
...
THINGDAQ_GPIO_DIAGNOSTIC_COLD_CODE(".flashmem.gpio_diagnostic.plan")
...
THINGDAQ_GPIO_DIAGNOSTIC_COLD_CODE(".flashmem.gpio_diagnostic.runner")

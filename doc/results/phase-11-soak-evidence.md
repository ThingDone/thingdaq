...
> current name, while `tdaq-*` build IDs and recorded hashes remain verbatim.
> The namespace, USB identity, and packaging rename requires a fresh physical
> campaign before the current candidate can inherit an equivalent decision.
...
This is the autonomous acceptance decision for that historical candidate. No
release was tagged, no package was uploaded or published, and the later
Windows handoff did not add a physical run. See [[Evidence-Index]] for the
current-candidate boundary and complete cross-phase map.
...
| Package version | retired pre-rename local distribution 0.10.0 |
...
| --- | --- | ---: | --- |
| A | pre-rename wheel, version 0.10.0 | 178,120 | `a086facfc564ae5d2a4c143556aa6a8487ff65f19eb2879b99a8d0d846153c31` |
| B | pre-rename wheel, version 0.10.0 | 178,120 | `a086facfc564ae5d2a4c143556aa6a8487ff65f19eb2879b99a8d0d846153c31` |
| A | pre-rename source distribution, version 0.10.0 | 195,949 | `d537004ddd3af9e7ac1199d263c392082f25c946b66638a813acb26d718f7136` |
| B | pre-rename source distribution, version 0.10.0 | 195,953 | `1f51a3eab60d627ab7751da50a7f20da6ba506894033b73b90fc710248e56f90` |

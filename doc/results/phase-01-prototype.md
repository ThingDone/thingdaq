...
```bash
.venv/bin/thingdaq-demo --frame-count 3 --parser-chunk-size 1
.venv/bin/thingdaq-demo --frame-count 3 --parser-chunk-size 17
.venv/bin/thingdaq-demo --frame-count 3 --parser-chunk-size 4096
```

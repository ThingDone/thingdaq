...
The experimental D16-D23 array is separately matched to protocol v2 and to
...
| 3 | 31 | `DMAMUX_SOURCE_XBAR1_1` | Auxiliary GPIO capture (experimental INPUT) |
...
When experimental INPUT is enabled, arbitration is reassigned in exact

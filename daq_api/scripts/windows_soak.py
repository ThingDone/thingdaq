    ...
    r"""
{
  ...
  "windows_driver_sha256": "ca828046c748bd587abd0e89971cfbdffd69f78e91e91dfb5a6c600ac4caa993",
...
def build_windows_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Standalone, release-identity-pinned Teensy DAQ Windows soak validator"
        )
    )
    parser.add_argument(
        "--mode",

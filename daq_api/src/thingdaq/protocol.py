...
class ParserCounters(_SharedParserCounters):
    """Protocol-v1 public parser-counter snapshot.

    The implementation fields live in the shared bounded framing core, while
    this compatibility type retains the original public module and class name.
    """
